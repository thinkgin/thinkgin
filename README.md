...
[![Version](https://img.shields.io/badge/Version-3.12.0-orange)](CHANGELOG.md)
[![License](https://img.shields.io/badge/License-MIT-green.svg)](LICENSE)

> **当前版本 3.12.0** — 内置 18 个可插拔中间件 + **自定义中间件注册表**、ServiceContext 依赖注入、WebSocket、按路由粒度熔断器、atomic 配置热更新、slog 标准日志引擎等。  
